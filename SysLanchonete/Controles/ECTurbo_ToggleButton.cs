...
namespace ECTurbo.Controles
{
    public class ECTurbo_ToggleButton : CheckBox
    {
        ...
        {
            Rectangle Base = new Rectangle(0, 0, (int)(Height * 1.4f), Height);
            Base.Inflate(-1, -1);

            Rectangle bFundo = Base;
            bFundo.Inflate(0, -4);
            ...
            if (Checked)
                bFundo.X = (int)(startX + (endX - startX) * animationProgress);
            else
                bFundo.X = (int)(endX - (endX - startX) * animationProgress);
        ...
        {
            Rectangle Base = new Rectangle(0, 0, (int)(Height * 1.7f), Height);
            Base.Inflate(-1, -1);
